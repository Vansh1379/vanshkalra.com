        ...
        <div className="h-[70rem] lg:h-[40rem] w-full rounded-md  relative flex flex-col items-center justify-center antialiased">
          <div className="max-w-3xl mx-auto pb-40 lg:pb-4 px-4">
            ...
            <p className="text-neutral-500 mt-8 text-lg max-w-3xl mx-auto my-8  text-center relative z-10">
              Greetings! I&apos;m Vansh Kalra, a recent B-Tech graduate from The
              JMIT, Radaur in Computer Science, specializing in crafting
              captivating and user-centric digital experiences. My journey in
              web development is driven by a fervent passion for innovation and
              a dedication to excellence. I bring to the table a comprehensive
              skill set encompassing both front-end and back-end development,
              empowering me to transform concepts into seamless and dynamic web
              solutions. Currently interested in AI and an active contributor in
              Open Source
            </p>
          </div>
          <BackgroundBeams />
