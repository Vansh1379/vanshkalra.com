    ...
    <div className="z-50">
      <div className="flex justify-between text-white ">
        <div className="hidden lg:flex px-12 pt-4 w-full items-center">
          {navLinks.map((link) => (
            <div className="lg:ml-4" key={link.id}>
        ...
        <div className="lg:hidden flex flex-1 justify-start items-center w-full z-50">
          ...
          <div
            className={`${
              !toggle ? "hidden" : "flex"
            } p-6 bg-neutral-900  absolute top-10 left-0 lg:mx-4 my-2 w-full lg:w-96 z-50 rounded-xl`}
          >
              ...
              {navLinks.map((link) => (
                <Link href={link.id} key={link.id}>
                  <li
                    ...
                    className="cursor-pointer w-96 p-2 hover:bg-neutral-700"
                  >
                    {link.title}
                  </li>
                </Link>
